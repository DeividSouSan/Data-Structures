from TestAddMethod.test_add_method import TestAddMethod
from TestDeleteMethod.test_delete_method import TestDeleteMethod
from TestAddToMethod.test_add_to_method import TestAddToMethod
